...
## ================================================================================================
# Terraform Stuff
ARG TERRAFORM_VERSION=1.11.3@sha256:c2c17884347f9b5f3d71067a3ef1fb736f748979f89b35a2e4b5225735e7fe01
...
ARG SOPS_VERSION=v3.10.0@sha256:39cdaa978bdda9b88fd079ee4f88ed7bdd96d8dfa88a7d82fbaf280c257300a7
...
# Kubectl + Plugins
ARG KUBECTL_VERSION=1.32.3@sha256:3f21647d4c3f0fa0a906d6aacf7919beac2356bf6a2fb595414bea045ba75270
...
ARG K9S_VERSION=v0.40.10@sha256:6f83f466b26862248fb73951cbb38d2ad8629c94ca8aa035c0c379159bcb7898
...
ARG TALSWITCHER_VERSION=v2.0.1@sha256:ceb1cc77f93e97ffc67ffb633675352d29e62207ea0f12a36289554d12687b0a
...
## Main image
## ================================================================================================
FROM mcr.microsoft.com/devcontainers/python:3.13-bullseye@sha256:c30134ea443e4f450595a814ca2c09ae753bfee1e777581c2ab6f2961c002a70 AS workspace
ENV EDITOR=vim
