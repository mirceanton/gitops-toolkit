...
## ================================================================================================
# Terraform Stuff
ARG TERRAFORM_VERSION=1.10.1@sha256:e2253e8196510ea0335702eaa26cf5acf12a2aae46bf8ec51e936cd536f482d9
...
ARG SOPS_VERSION=v3.9.2-alpine@sha256:5b35be348155b0486b86bc9f63bd59eafac6e9c269837dab1b5c1e980a088711
...
# Kubectl + Plugins
ARG KUBECTL_VERSION=1.31.3@sha256:3e89d1d1dbd10b1809bde3436bbe9f3708ad4c7d3ad4a9551cd8a16d88400365
...
ARG TALHELPER_VERSION=v3.0.10@sha256:8c002f08c822379914d7f2bc05cb62c9933de2ffd44eb95a64cdd30caadbc59c
...
## ================================================================================================
FROM alpine@sha256:5cc1526ee5c99c2982793abe22861e6047cfb5c8609cbe2d6bbe11d836263354 AS bitwarden-cli
...
FROM alpine@sha256:5cc1526ee5c99c2982793abe22861e6047cfb5c8609cbe2d6bbe11d836263354 AS helm
ARG HELM_VERSION
RUN wget https://get.helm.sh/helm-${HELM_VERSION}-linux-amd64.tar.gz -O helm.tar.gz && \
	tar xvf helm.tar.gz && \
	mv linux-amd64/helm /bin/helm

FROM alpine@sha256:5cc1526ee5c99c2982793abe22861e6047cfb5c8609cbe2d6bbe11d836263354 AS kubectl-pgo
...
FROM alpine@sha256:5cc1526ee5c99c2982793abe22861e6047cfb5c8609cbe2d6bbe11d836263354 AS cmctl
ARG CMCTL_VERSION
